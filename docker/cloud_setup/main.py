...
from cloud_setup.protection.GridProtectionManager import GridProtectionManager
...
if __name__ == "__main__":
    ...
    # certificates has to be generated first, if user wants to use secured OPC-UA server-client connection
